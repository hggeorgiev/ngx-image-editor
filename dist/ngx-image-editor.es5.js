import { Attribute, ChangeDetectionStrategy, ChangeDetectorRef, Component, ContentChild, ContentChildren, Directive, ElementRef, EventEmitter, Host, Inject, Injectable, InjectionToken, Injector, Input, NgModule, NgZone, Optional, Output, Renderer2, SecurityContext, Self, SkipSelf, TemplateRef, Version, ViewChild, ViewChildren, ViewContainerRef, ViewEncapsulation, forwardRef, isDevMode } from '@angular/core';
import { ActiveDescendantKeyManager, AriaDescriber, FocusKeyManager, FocusMonitor, FocusTrapFactory, LiveAnnouncer, isFakeMousedownFromScreenReader } from '@angular/cdk/a11y';
import { Directionality } from '@angular/cdk/bidi';
import { DOCUMENT, DomSanitizer, HammerGestureConfig } from '@angular/platform-browser';
import { coerceBooleanProperty, coerceNumberProperty } from '@angular/cdk/coercion';
import { Subject as Subject$1 } from 'rxjs/Subject';
import { BACKSPACE, DELETE, DOWN_ARROW, END, ENTER, ESCAPE, HOME, LEFT_ARROW, PAGE_DOWN, PAGE_UP, RIGHT_ARROW, SPACE, UP_ARROW } from '@angular/cdk/keycodes';
import { Location } from '@angular/common';
import { ScrollDispatcher, ViewportRuler } from '@angular/cdk/scrolling';
import { Platform, getSupportedInputTypes } from '@angular/cdk/platform';
import { ConnectedOverlayDirective, Overlay, OverlayConfig, ViewportRuler as ViewportRuler$1 } from '@angular/cdk/overlay';
import { BasePortalHost, ComponentPortal, PortalHostDirective, TemplatePortal, TemplatePortalDirective } from '@angular/cdk/portal';
...
import { first as first$2 } from 'rxjs/operator/first';
...
var MdFormField = (function () {
    ...
    MdFormField.prototype._animateAndLockPlaceholder = function () {
        ...
        if (this._placeholder && this._canPlaceholderFloat) {
            ...
            first.call(fromEvent$1(this._placeholder.nativeElement, 'transitionend')).subscribe(function () {
...
var MdAutocompleteTrigger = (function () {
    ...
    Object.defineProperty(MdAutocompleteTrigger.prototype, "_outsideClickStream", {
        ...
        get: function () {
            ...
            return RxChain.from(merge$1(fromEvent$1(this._document, 'click'), fromEvent$1(this._document, 'touchend'))).call(filter, function (event) {
    ...
    MdAutocompleteTrigger.prototype._subscribeToClosingActions = function () {
        ...
        return RxChain.from(merge$1(firstStable, optionChanges))
...
var MdChipList = (function () {
    ...
    function MdChipList(_renderer, _elementRef, _changeDetectorRef, _dir, _parentForm, _parentFormGroup, ngControl) {
         ...
         */
        this._tabOutSubscription = Subscription$1.EMPTY;
        /**
...
var MdIconRegistry = (function () {
    ...
    MdIconRegistry.prototype._getSvgFromIconSetConfigs = function (name, iconSetConfigs) {
        ...
        return map.call(forkJoin$1.call(Observable$1, iconSetFetchRequests), function () {
...
var MdCalendar = (function () {
    ...
    MdCalendar.prototype._focusActiveCell = function () {
        var _this = this;
        this._ngZone.runOutsideAngular(function () {
            first$2.call(_this._ngZone.onStable.asObservable()).subscribe(function () {
...
var MdDatepickerToggle = (function () {
    ...
    MdDatepickerToggle.prototype.ngOnChanges = function (changes) {
        ...
        if (changes.datepicker) {
            ...
            var /** @type {?} */ datepickerDisabled = datepicker ? datepicker._disabledChange : of$1();
...
var MdExpansionPanelHeader = (function () {
    ...
    function MdExpansionPanelHeader(renderer, panel, _element, _focusMonitor, _changeDetectorRef) {
        ...
        this._parentChangeSubscription = merge$1(panel.opened, panel.closed, filter.call(panel._inputChanges, function (changes) { return !!(changes.hideToggle || changes.disabled); }))
            .subscribe(function () { return _this._changeDetectorRef.markForCheck(); });
...
var MdSelectionList = (function (_super) {
    ...
    function MdSelectionList(_element) {
         ...
         */
        _this._optionFocusSubscription = Subscription$1.EMPTY;
        /**
         * Subscription to all list options' destroy events
         */
        _this._optionDestroyStream = Subscription$1.EMPTY;
        /**
    ...
    MdSelectionList.prototype._onDestroySubscription = function () {
        ...
        return RxChain.from(this.options.changes)
            ...
            return merge$1.apply(void 0, options.map(function (option) { return option.destroyed; }));
    ...
    MdSelectionList.prototype._onFocusSubscription = function () {
        ...
        return RxChain.from(this.options.changes)
            .call(startWith, this.options)
            .call(switchMap, function (options) {
            return merge$1.apply(void 0, options.map(function (option) { return option.onFocus; }));
        }).subscribe(function (e) {
            var /** @type {?} */ optionIndex = _this.options.toArray().indexOf(e.option);
...
var MdMenu = (function () {
    ...
    MdMenu.prototype.hover = function () {
        return RxChain.from(this.items.changes)
            ...
            .call(switchMap, function (items) { return merge$1.apply(void 0, items.map(function (item) { return item.hover; })); })
            .result();
    };
    /**
...
var MdMenuTrigger = (function () {
    ...
    MdMenuTrigger.prototype._menuClosingActions = function () {
        ...
        var /** @type {?} */ parentClose = this._parentMenu ? this._parentMenu.close : of$1(null);
        var /** @type {?} */ hover = this._parentMenu ? RxChain.from(this._parentMenu.hover())
            ...
            .result() : of$1(null);
        return merge$1(backdrop, parentClose, hover);
    };
    /**
...
var MdSelect = (function (_super) {
    ...
    function MdSelect(_viewportRuler, _changeDetectorRef, _platform, renderer, elementRef, _dir, _parentForm, _parentFormGroup, _control, tabIndex, placeholderOptions, _scrollStrategyFactory) {
         ...
         */
        _this._optionSubscription = Subscription$1.EMPTY;
        /**
         * Subscription to changes in the option list.
         */
        _this._changeSubscription = Subscription$1.EMPTY;
        /**
         * Subscription to tab events while overlay is focused.
         */
        _this._tabSubscription = Subscription$1.EMPTY;
        /**
...
var MdDrawerContainer = (function () {
    ...
    function MdDrawerContainer(_dir, _element, _renderer, _ngZone, _changeDetectorRef) {
         ...
         */
        this._dirChangeSubscription = Subscription$1.EMPTY;
    ...
    MdDrawerContainer.prototype._watchDrawerToggle = function (drawer) {
        ...
        if (drawer.mode !== 'side') {
            takeUntil.call(merge$1(drawer.onOpen, drawer.onClose), this._drawers.changes).subscribe(function () { return _this._setContainerClass(drawer.opened); });
        }
    };
    /**
...
var MdSortHeader = (function () {
    ...
    function MdSortHeader(_intl, changeDetectorRef, _sort, _cdkColumnDef) {
        ...
        this._rerenderSubscription = merge$1(_sort.sortChange, _intl.changes).subscribe(function () {
...
var MdTabHeader = (function (_super) {
    ...
    MdTabHeader.prototype.ngAfterContentInit = function () {
        var _this = this;
        var /** @type {?} */ dirChange = this._dir ? this._dir.change : of$1(null);
        var /** @type {?} */ resize = typeof window !== 'undefined' ?
            auditTime.call(fromEvent$1(window, 'resize'), 150) :
            of$1(null);
        this._realignInkBar = startWith.call(merge$1(dirChange, resize), null).subscribe(function () {
...
var MdTabNav = (function (_super) {
    ...
    MdTabNav.prototype.ngAfterContentInit = function () {
        ...
        this._ngZone.runOutsideAngular(function () {
            ...
            var /** @type {?} */ resize = typeof window !== 'undefined' ?
                auditTime.call(fromEvent$1(window, 'resize'), 10) :
                of$1(null);
            return takeUntil.call(merge$1(dirChange, resize), _this._onDestroy).subscribe(function () {
                _this._alignInkBar();
            });
        });
        this._setLinkDisableRipple();
...
NgxImageEditorComponent.ctorParameters = function () { return [
    { type: MdDialogRef, },
    { type: undefined, decorators: [{ type: Optional }, { type: Inject, args: [MD_DIALOG_DATA,] },] },
    { type: DomSanitizer, },
]; };
 ...
 */
export { NgxImageEditorModule, NgxImageEditorComponent, NGX_DEFAULT_RATIOS };
//# sourceMappingURL=ngx-image-editor.es5.js.map
