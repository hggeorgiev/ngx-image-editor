...
import { A11yModule, ActiveDescendantKeyManager, FocusKeyManager, FocusTrapFactory, LiveAnnouncer, isFakeMousedownFromScreenReader } from '@angular/cdk/a11y';
import { BidiModule, Directionality } from '@angular/cdk/bidi';
import { ObserversModule } from '@angular/cdk/observers';
import { ConnectedOverlayDirective, Overlay, OverlayModule, OverlayState, ViewportRuler } from '@angular/cdk/overlay';
import { BasePortalHost, ComponentPortal, PortalHostDirective, PortalModule, TemplatePortal, TemplatePortalDirective } from '@angular/cdk/portal';
...
var MdTabGroup = (function (_super) {
    ...
    MdTabGroup.prototype._subscribeToTabLabels = function () {
        ...
        this._tabLabelSubscription = merge$1.apply(void 0, this._tabs.map(function (tab) { return tab._labelChange; })).subscribe(function () {
            _this._changeDetectorRef.markForCheck();
        });
    };
    /**
    ...
    MdTabNav.prototype.ngAfterContentInit = function () {
        ...
        this._resizeSubscription = this._ngZone.runOutsideAngular(function () {
            ...
            var /** @type {?} */ resize = typeof window !== 'undefined' ?
                ...
                of$1(null);
            return takeUntil.call(merge$1(dirChange, resize), _this._onDestroy)
...
var MdMenu = (function () {
    ...
    MdMenu.prototype.hover = function () {
        return merge$1.apply(void 0, this.items.map(function (item) { return item.hover; }));
    };
    /**
...
var MdSortHeader = (function () {
    ...
    function MdSortHeader(_intl, changeDetectorRef, _sort, _cdkColumnDef) {
        ...
        this._rerenderSubscription = merge$1(_sort.mdSortChange, _intl.changes).subscribe(function () {
