(function (global, factory) {
	...
	(factory((global['ngx-image-editor'] = {}),global.ng.core,global.ng.cdk.a11y,global.ng.cdk.bidi,global.ng.platformBrowser,global.ng.cdk.coercion,global.Rx,global.ng.cdk.keycodes,global.ng.common,global.ng.cdk.scrolling,global.ng.cdk.platform,global.ng.cdk.overlay,global.ng.cdk.portal,global.ng.cdk.rxjs,global.ng.forms,global.ng.animations,global.Rx.Observable,global.Rx.Observable,global.Rx.Observable,global.ng.cdk.observers,global.ng.cdk.collections,global.Rx,global.Rx.Observable,global.ng.http,global.Rx,global.Rx.Observable,global.Rx.Observable,global.Rx.Observable.prototype,global.ng.cdk.table,global.ng.cdk.stepper));
}(this, (function (exports,core,a11y,bidi,platformBrowser,coercion,Subject,keycodes,common,scrolling,platform,overlay,portal,rxjs,forms,animations,fromEvent,merge,of,observers,collections,Subscription,defer,http,Observable,forkJoin,_throw,first$1,table,stepper) { 'use strict';
...
var RippleRenderer = (function () {
     ...
     * @param {?} platform
     */
    function RippleRenderer(elementRef, _ngZone, _ruler, platform$$1) {
...
var MdRipple = (function () {
     ...
     * @param {?} globalOptions
     */
    function MdRipple(elementRef, ngZone, ruler, platform$$1, globalOptions) {
        /**
         ...
         */
        this.speedFactor = 1;
        this._rippleRenderer = new RippleRenderer(elementRef, ngZone, ruler, platform$$1);
...
MdRipple.propDecorators = {
    ...
    '_matRippleTrigger': [{ type: core.Input, args: ['matRippleTrigger',] },],
    '_matRippleCentered': [{ type: core.Input, args: ['matRippleCentered',] },],
    '_matRippleDisabled': [{ type: core.Input, args: ['matRippleDisabled',] },],
    '_matRippleRadius': [{ type: core.Input, args: ['matRippleRadius',] },],
    '_matRippleSpeedFactor': [{ type: core.Input, args: ['matRippleSpeedFactor',] },],
    '_matRippleColor': [{ type: core.Input, args: ['matRippleColor',] },],
    '_matRippleUnbounded': [{ type: core.Input, args: ['matRippleUnbounded',] },],
};
/**
...
var MdFormField = (function () {
    ...
    MdFormField.prototype.ngAfterContentInit = function () {
        ...
        rxjs.startWith.call(this._control.stateChanges, null).subscribe(function () {
        ...
        rxjs.startWith.call(this._hintChildren.changes, null).subscribe(function () {
            _this._processHints();
            _this._changeDetectorRef.markForCheck();
        });
        // Update the aria-described by when the number of errors changes.
        rxjs.startWith.call(this._errorChildren.changes, null).subscribe(function () {
            _this._syncDescribedByIds();
            _this._changeDetectorRef.markForCheck();
        });
    };
    ...
    MdFormField.prototype._animateAndLockPlaceholder = function () {
        ...
        if (this._placeholder && this._canPlaceholderFloat) {
            ...
            rxjs.first.call(fromEvent.fromEvent(this._placeholder.nativeElement, 'transitionend')).subscribe(function () {
 ...
 * @nocollapse
 */
MdFormField.ctorParameters = function () {
    return [
        { type: core.ElementRef, },
        { type: core.ChangeDetectorRef, },
...
MdFormField.propDecorators = {
    ...
    '_placeholder': [{ type: core.ViewChild, args: ['placeholder',] },],
    '_control': [{ type: core.ContentChild, args: [MdFormFieldControl,] },],
    '_placeholderChild': [{ type: core.ContentChild, args: [MdPlaceholder,] },],
    '_errorChildren': [{ type: core.ContentChildren, args: [MdError,] },],
 ...
 */
var MD_AUTOCOMPLETE_SCROLL_STRATEGY = new core.InjectionToken('md-autocomplete-scroll-strategy');
/**
...
var MdAutocompleteTrigger = (function () {
    ...
    Object.defineProperty(MdAutocompleteTrigger.prototype, "_outsideClickStream", {
        ...
        get: function () {
            ...
            return rxjs.RxChain.from(merge.merge(fromEvent.fromEvent(this._document, 'click'), fromEvent.fromEvent(this._document, 'touchend'))).call(rxjs.filter, function (event) {
    ...
    MdAutocompleteTrigger.prototype._handleKeydown = function (event) {
        var _this = this;
        if (event.keyCode === keycodes.ESCAPE && this.panelOpen) {
            this._resetActiveItem();
            this.closePanel();
            event.stopPropagation();
        }
        else if (this.activeOption && event.keyCode === keycodes.ENTER && this.panelOpen) {
            ...
            var /** @type {?} */ isArrowKey_1 = event.keyCode === keycodes.UP_ARROW || event.keyCode === keycodes.DOWN_ARROW;
            if (this.panelOpen) {
    ...
    MdAutocompleteTrigger.prototype._subscribeToClosingActions = function () {
        var _this = this;
        var /** @type {?} */ firstStable = rxjs.first.call(this._zone.onStable.asObservable());
        var /** @type {?} */ optionChanges = rxjs.map.call(this.autocomplete.options.changes, function () { return _this._positionStrategy.recalculateLastPosition(); });
        // When the zone is stable initially, and when the option list changes...
        return rxjs.RxChain.from(merge.merge(firstStable, optionChanges))
            .call(rxjs.switchMap, function () {
...
MdAutocompleteTrigger.ctorParameters = function () {
    return [
        ...
        { type: core.NgZone, },
        { type: core.ChangeDetectorRef, },
        { type: undefined, decorators: [{ type: core.Inject, args: [MD_AUTOCOMPLETE_SCROLL_STRATEGY,] },] },
        { type: bidi.Directionality, decorators: [{ type: core.Optional },] },
        { type: MdFormField, decorators: [{ type: core.Optional }, { type: core.Host },] },
...
var MdAnchor = (function (_super) {
     ...
     * @param {?} renderer
     */
    function MdAnchor(platform$$1, focusMonitor, elementRef, renderer) {
        return _super.call(this, renderer, elementRef, platform$$1, focusMonitor) || this;
    }
    /**
     * @param {?} event
     * @return {?}
 ...
 * @nocollapse
 */
MdButtonToggleGroup.ctorParameters = function () {
    return [
        { type: core.ChangeDetectorRef, },
    ];
};
...
var _MdCheckboxRequiredValidator = forms.CheckboxRequiredValidator;
var MD_CHECKBOX_REQUIRED_VALIDATOR = {
    provide: forms.NG_VALIDATORS,
    useExisting: core.forwardRef(function () { return MdCheckboxRequiredValidator; }),
    multi: true
};
/**
...
var MdChip = (function (_super) {
    ...
    Object.defineProperty(MdChip.prototype, "selectable", {
         ...
         * @return {?}
         */
        set: function (value) { this._selectable = coercion.coerceBooleanProperty(value); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(MdChip.prototype, "removable", {
         ...
         * @return {?}
         */
        set: function (value) { this._removable = coercion.coerceBooleanProperty(value); },
        enumerable: true,
        configurable: true
    });
...
var MdChipList = (function () {
    ...
    function MdChipList(_renderer, _elementRef, _changeDetectorRef, _dir, _parentForm, _parentFormGroup, ngControl) {
         ...
         */
        this._tabOutSubscription = Subscription.Subscription.EMPTY;
        /**
         ...
         */
        this._uid = "md-chip-list-" + nextUniqueId$2$1++;
        /**
    ...
    MdChipList.prototype.ngAfterContentInit = function () {
        ...
        this._changeSubscription = rxjs.startWith.call(this.chips.changes, null).subscribe(function () {
            _this._resetChips();
    ...
    MdChipList.prototype._keydown = function (event) {
        ...
        var /** @type {?} */ isBackKey = (code === keycodes.BACKSPACE || code == keycodes.DELETE || code == keycodes.UP_ARROW || isPrevKey);
 ...
 * @nocollapse
 */
MdChipList.ctorParameters = function () {
    return [
        { type: core.Renderer2, },
        { type: core.ElementRef, },
        { type: core.ChangeDetectorRef, },
...
MdChipList.propDecorators = {
    ...
    'chips': [{ type: core.ContentChildren, args: [MdChip,] },],
};
/**
 ...
 * @nocollapse
 */
MdChipInput.ctorParameters = function () {
    return [
        { type: core.ElementRef, },
    ];
};
MdChipInput.propDecorators = {
    'chipList': [{ type: core.Input, args: ['mdChipInputFor',] },],
    'addOnBlur': [{ type: core.Input, args: ['mdChipInputAddOnBlur',] },],
    'separatorKeyCodes': [{ type: core.Input, args: ['mdChipInputSeparatorKeyCodes',] },],
    'chipEnd': [{ type: core.Output, args: ['mdChipInputTokenEnd',] },],
    '_matChipInputTokenEnd': [{ type: core.Output, args: ['matChipInputTokenEnd',] },],
    'matChipList': [{ type: core.Input, args: ['matChipInputFor',] },],
    'matAddOnBlur': [{ type: core.Input, args: ['matChipInputAddOnBlur',] },],
    'matSeparatorKeyCodes': [{ type: core.Input, args: ['matChipInputSeparatorKeyCodes',] },],
    'placeholder': [{ type: core.Input },],
};
/**
 * @license
...
var MdDialogContainer = (function (_super) {
     ...
     * @return {?}
     */
    MdDialogContainer.prototype.attachComponentPortal = function (portal$$1) {
     ...
     * @return {?}
     */
    MdDialogContainer.prototype.attachTemplatePortal = function (portal$$1) {
        if (this._portalHost.hasAttached()) {
            throwMdDialogContentAlreadyAttachedError();
        }
        this._savePreviouslyFocusedElement();
...
var MdDialogRef = (function () {
    ...
    function MdDialogRef(_overlayRef, _containerInstance, id) {
        ...
        rxjs.RxChain.from(_containerInstance._animationStateChanged)
            .call(rxjs.filter, function (event) { return event.phaseName === 'done' && event.toState === 'enter'; })
            .call(rxjs.first)
            .subscribe(function () {
        ...
        rxjs.RxChain.from(_containerInstance._animationStateChanged)
            .call(rxjs.filter, function (event) { return event.phaseName === 'done' && event.toState === 'exit'; })
            .call(rxjs.first)
            .subscribe(function () {
    ...
    MdDialogRef.prototype.close = function (dialogResult) {
        ...
        rxjs.RxChain.from(this._containerInstance._animationStateChanged)
            .call(rxjs.filter, function (event) { return event.phaseName === 'start'; })
            .call(rxjs.first)
            .subscribe(function () {
 ...
 */
var MD_DIALOG_SCROLL_STRATEGY = new core.InjectionToken('md-dialog-scroll-strategy');
/**
...
var MdDialog = (function () {
    ...
    function MdDialog(_overlay, _injector, location, _scrollStrategy, _parentDialog) {
        ...
        this.afterAllClosed = defer.defer(function () {
            return _this.openDialogs.length ?
                ...
                rxjs.startWith.call(_this._afterAllClosed, undefined);
        });
     ...
     */
    MdDialog.prototype._attachDialogContainer = function (overlay$$1, config) {
        var /** @type {?} */ containerPortal = new portal.ComponentPortal(MdDialogContainer, config.viewContainerRef);
    ...
    MdDialog.prototype._handleKeydown = function (event) {
        ...
        if (event.keyCode === keycodes.ESCAPE && canClose) {
            topDialog.close();
        }
    };
    return MdDialog;
...
MdDialog.ctorParameters = function () {
    return [
        ...
        { type: undefined, decorators: [{ type: core.Inject, args: [MD_DIALOG_SCROLL_STRATEGY,] },] },
...
var MdIconRegistry = (function () {
    ...
    MdIconRegistry.prototype.getSvgIconFromUrl = function (safeUrl) {
        ...
        return rxjs.RxChain.from(this._loadSvgIconFromConfig(new SvgIconConfig(url)))
            .call(rxjs.doOperator, function (svg) { return _this._cachedIconsByUrl.set(/** @type {?} */ ((url)), svg); })
            .call(rxjs.map, function (svg) { return cloneSvg(svg); })
            .result();
    };
    /**
    ...
    MdIconRegistry.prototype._getSvgFromConfig = function (config) {
        if (config.svgElement) {
            ...
            return rxjs.RxChain.from(this._loadSvgIconFromConfig(config))
                .call(rxjs.doOperator, function (svg) { return config.svgElement = svg; })
                .call(rxjs.map, function (svg) { return cloneSvg(svg); })
                .result();
        }
    };
    ...
    MdIconRegistry.prototype._getSvgFromIconSetConfigs = function (name, iconSetConfigs) {
        ...
        var /** @type {?} */ iconSetFetchRequests = iconSetConfigs
            ...
            return rxjs.RxChain.from(_this._loadSvgIconSetFromConfig(iconSetConfig))
                .call(rxjs.catchOperator, function (err) {
                ...
                .call(rxjs.doOperator, function (svg) {
        ...
        return rxjs.map.call(forkJoin.forkJoin.call(Observable.Observable, iconSetFetchRequests), function () {
    ...
    MdIconRegistry.prototype._loadSvgIconFromConfig = function (config) {
        var _this = this;
        return rxjs.map.call(this._fetchUrl(config.url), function (svgText) { return _this._createSvgElementForSingleIcon(svgText); });
    };
    /**
    ...
    MdIconRegistry.prototype._loadSvgIconSetFromConfig = function (config) {
        ...
        return rxjs.map.call(this._fetchUrl(config.url), function (svgText) { return _this._svgElementFromString(svgText); });
    };
    /**
    ...
    MdIconRegistry.prototype._fetchUrl = function (safeUrl) {
        ...
        var /** @type {?} */ req = rxjs.RxChain.from(this._http.get(url))
            .call(rxjs.map, function (response) { return response.text(); })
            .call(rxjs.finallyOperator, function () { return _this._inProgressUrlFetches.delete(url); })
            .call(rxjs.share)
            .result();
    ...
    MdIcon.prototype.ngOnChanges = function (changes) {
        ...
        if (changes.svgIcon) {
            if (this.svgIcon) {
                ...
                rxjs.first.call(this._mdIconRegistry.getNamedSvgIcon(iconName, namespace)).subscribe(function (svg) { return _this._setSvgElement(svg); }, function (err) { return console.log("Error retrieving icon: " + err.message); });
            }
            else {
...
var MdCalendar = (function () {
    ...
    MdCalendar.prototype._focusActiveCell = function () {
        var _this = this;
        this._ngZone.runOutsideAngular(function () {
            first$1.first.call(_this._ngZone.onStable.asObservable()).subscribe(function () {
...
MdCalendar.decorators = [
    { type: core.Component, args: [{ selector: 'md-calendar, mat-calendar',
...
MdCalendarBody.decorators = [
    { type: core.Component, args: [{ selector: '[md-calendar-body], [mat-calendar-body]',
...
MdDatepickerContent.decorators = [
    { type: core.Component, args: [{ selector: 'md-datepicker-content, mat-datepicker-content',
...
var MdDatepicker = (function () {
    ...
    MdDatepicker.prototype._openAsPopup = function () {
        ...
        if (!this._calendarPortal) {
            this._calendarPortal = new portal.ComponentPortal(MdDatepickerContent, this._viewContainerRef);
        }
        if (!this._popupRef) {
            this._createPopup();
        }
        if (!this._popupRef.hasAttached()) {
            ...
            rxjs.first.call(this._ngZone.onStable.asObservable()).subscribe(function () {
 ...
 * @nocollapse
 */
MdDatepicker.ctorParameters = function () {
    return [
        { type: MdDialog, },
        { type: overlay.Overlay, },
        { type: core.NgZone, },
...
MdDatepickerInput.ctorParameters = function () {
    return [
        ...
        { type: DateAdapter, decorators: [{ type: core.Optional },] },
        { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [MD_DATE_FORMATS,] },] },
        { type: MdFormField, decorators: [{ type: core.Optional },] },
    ];
};
...
var MdDatepickerToggle = (function () {
    ...
    MdDatepickerToggle.prototype.ngOnChanges = function (changes) {
        ...
        if (changes.datepicker) {
            ...
            var /** @type {?} */ datepickerDisabled = datepicker ? datepicker._disabledChange : of.of();
...
MdDatepickerToggle.decorators = [
    { type: core.Component, args: [{ selector: 'md-datepicker-toggle, mat-datepicker-toggle',
 ...
 * @nocollapse
 */
MdDatepickerToggle.ctorParameters = function () {
    return [
        { type: MdDatepickerIntl, },
        { type: core.ChangeDetectorRef, },
    ];
...
MdYearView.decorators = [
    { type: core.Component, args: [{ selector: 'md-year-view, mat-year-view',
...
var MdExpansionPanelHeader = (function () {
    ...
    function MdExpansionPanelHeader(renderer, panel, _element, _focusMonitor, _changeDetectorRef) {
        ...
        this._parentChangeSubscription = merge.merge(panel.opened, panel.closed, rxjs.filter.call(panel._inputChanges, function (changes) { return !!(changes.hideToggle || changes.disabled); }))
            .subscribe(function () { return _this._changeDetectorRef.markForCheck(); });
 ...
 * @nocollapse
 */
MdInput.ctorParameters = function () {
    return [
        { type: core.ElementRef, },
        { type: core.Renderer2, },
        { type: platform.Platform, },
...
MdTextareaAutosize.propDecorators = {
    ...
    '_matAutosizeMinRows': [{ type: core.Input, args: ['matAutosizeMinRows',] },],
...
var MdListOption = (function (_super) {
    ...
    function MdListOption(_renderer, _element, _changeDetector, selectionList) {
         ...
         */
        _this.selectChange = new core.EventEmitter();
        /**
         * Emitted when the option is deselected.
         */
        _this.deselected = new core.EventEmitter();
        /**
...
MdListOption.decorators = [
    { type: core.Component, args: [{ selector: 'md-list-option, mat-list-option',
                inputs: ['disableRipple'],
                host: {
                    'role': 'option',
 ...
 * @nocollapse
 */
MdListOption.ctorParameters = function () {
    return [
        { type: core.Renderer2, },
        { type: core.ElementRef, },
        { type: core.ChangeDetectorRef, },
        { type: MdSelectionList, decorators: [{ type: core.Optional }, { type: core.Inject, args: [core.forwardRef(function () { return MdSelectionList; }),] },] },
    ];
};
...
var MdSelectionList = (function (_super) {
    ...
    function MdSelectionList(_element) {
         ...
         */
        _this._optionFocusSubscription = Subscription.Subscription.EMPTY;
        /**
         * Subscription to all list options' destroy events
         */
        _this._optionDestroyStream = Subscription.Subscription.EMPTY;
        /**
    ...
    MdSelectionList.prototype._onDestroySubscription = function () {
        var _this = this;
        return rxjs.RxChain.from(this.options.changes)
            .call(rxjs.startWith, this.options)
            .call(rxjs.switchMap, function (options) {
            return merge.merge.apply(void 0, options.map(function (option) { return option.destroyed; }));
    ...
    MdSelectionList.prototype._onFocusSubscription = function () {
        ...
        return rxjs.RxChain.from(this.options.changes)
            .call(rxjs.startWith, this.options)
            .call(rxjs.switchMap, function (options) {
            return merge.merge.apply(void 0, options.map(function (option) { return option.onFocus; }));
        }).subscribe(function (e) {
            var /** @type {?} */ optionIndex = _this.options.toArray().indexOf(e.option);
...
MdSelectionList.decorators = [
    { type: core.Component, args: [{ selector: 'md-selection-list, mat-selection-list',
 ...
 * @nocollapse
 */
MdSelectionList.ctorParameters = function () {
    return [
        { type: core.ElementRef, },
    ];
};
MdSelectionList.propDecorators = {
    'options': [{ type: core.ContentChildren, args: [MdListOption,] },],
};
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
...
var MdMenuItem = (function (_super) {
    ...
    function MdMenuItem(_elementRef) {
         ...
         */
        _this.hover = new Subject.Subject();
        /**
 ...
 */
var MD_MENU_DEFAULT_OPTIONS = new core.InjectionToken('md-menu-default-options');
/**
...
var MdMenu = (function () {
    ...
    MdMenu.prototype.ngAfterContentInit = function () {
        var _this = this;
        this._keyManager = new a11y.FocusKeyManager(this.items).withWrap();
    ...
    MdMenu.prototype.hover = function () {
        return rxjs.RxChain.from(this.items.changes)
            .call(rxjs.startWith, this.items)
            .call(rxjs.switchMap, function (items) { return merge.merge.apply(void 0, items.map(function (item) { return item.hover; })); })
            .result();
    };
    /**
...
MdMenu.ctorParameters = function () {
    return [
        { type: core.ElementRef, },
        { type: undefined, decorators: [{ type: core.Inject, args: [MD_MENU_DEFAULT_OPTIONS,] },] },
    ];
};
 ...
 */
var MD_MENU_SCROLL_STRATEGY = new core.InjectionToken('md-menu-scroll-strategy');
/**
...
var MdMenuTrigger = (function () {
    ...
    MdMenuTrigger.prototype.ngAfterViewInit = function () {
        ...
        if (this.triggersSubmenu()) {
            ...
            this._hoverSubscription = rxjs.filter
    ...
    MdMenuTrigger.prototype._menuClosingActions = function () {
        ...
        var /** @type {?} */ parentClose = this._parentMenu ? this._parentMenu.close : of.of(null);
        var /** @type {?} */ hover = this._parentMenu ? rxjs.RxChain.from(this._parentMenu.hover())
            .call(rxjs.filter, function (active) { return active !== _this._menuItemInstance; })
            .call(rxjs.filter, function () { return _this._menuOpen; })
            .result() : of.of(null);
        return merge.merge(backdrop, parentClose, hover);
    };
    /**
...
MdMenuTrigger.ctorParameters = function () {
    return [
        ...
        { type: core.ElementRef, },
        { type: core.ViewContainerRef, },
        { type: undefined, decorators: [{ type: core.Inject, args: [MD_MENU_SCROLL_STRATEGY,] },] },
        { type: MdMenu, decorators: [{ type: core.Optional },] },
        { type: MdMenuItem, decorators: [{ type: core.Optional }, { type: core.Self },] },
        { type: bidi.Directionality, decorators: [{ type: core.Optional },] },
    ];
};
 ...
 */
var MD_SELECT_SCROLL_STRATEGY = new core.InjectionToken('md-select-scroll-strategy');
/**
...
var MdSelect = (function (_super) {
    ...
    function MdSelect(_viewportRuler, _changeDetectorRef, _platform, renderer, elementRef, _dir, _parentForm, _parentFormGroup, _control, tabIndex, placeholderOptions, _scrollStrategyFactory) {
         ...
         */
        _this._optionSubscription = Subscription.Subscription.EMPTY;
        /**
         * Subscription to changes in the option list.
         */
        _this._changeSubscription = Subscription.Subscription.EMPTY;
        /**
         * Subscription to tab events while overlay is focused.
         */
        _this._tabSubscription = Subscription.Subscription.EMPTY;
        /**
    ...
    MdSelect.prototype.ngAfterContentInit = function () {
        ...
        this._changeSubscription = rxjs.startWith.call(this.options.changes, null).subscribe(function () {
            _this._resetOptions();
            _this._initializeSelection();
        });
    };
    ...
    MdSelect.prototype._handleClosedKeydown = function (event) {
        if (!this.disabled) {
            ...
            else if (event.keyCode === keycodes.UP_ARROW || event.keyCode === keycodes.DOWN_ARROW) {
    ...
    MdSelect.prototype._handlePanelKeydown = function (event) {
        if (event.keyCode === keycodes.HOME || event.keyCode === keycodes.END) {
            event.preventDefault();
    ...
    MdSelect.prototype._initKeyManager = function () {
        var _this = this;
        this._keyManager = new a11y.FocusKeyManager(this.options).withTypeAhead();
    ...
    MdSelect.prototype._listenToOptions = function () {
        var _this = this;
        this._optionSubscription = rxjs.filter.call(this.optionSelectionChanges, function (event) { return event.isUserInput; }).subscribe(function (event) {
...
MdSelect.ctorParameters = function () {
    return [
        ...
        { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [MD_PLACEHOLDER_GLOBAL_OPTIONS,] },] },
        { type: undefined, decorators: [{ type: core.Inject, args: [MD_SELECT_SCROLL_STRATEGY,] },] },
    ];
};
MdSelect.propDecorators = {
    'trigger': [{ type: core.ViewChild, args: ['trigger',] },],
    'overlayDir': [{ type: core.ViewChild, args: [overlay.ConnectedOverlayDirective,] },],
    'options': [{ type: core.ContentChildren, args: [MdOption, { descendants: true },] },],
    'optionGroups': [{ type: core.ContentChildren, args: [MdOptgroup,] },],
    'panelClass': [{ type: core.Input },],
    'customTrigger': [{ type: core.ContentChild, args: [MdSelectTrigger,] },],
    'placeholder': [{ type: core.Input },],
    'required': [{ type: core.Input },],
    'multiple': [{ type: core.Input },],
    'compareWith': [{ type: core.Input },],
 ...
 */
var MD_TOOLTIP_SCROLL_STRATEGY = new core.InjectionToken('md-tooltip-scroll-strategy');
/**
...
var MdTooltip = (function () {
    ...
    MdTooltip.prototype._createTooltip = function () {
        ...
        this._tooltipInstance = overlayRef.attach(portal$$1).instance; /** @type {?} */
        ((
    ...
    MdTooltip.prototype._updateTooltipMessage = function () {
        ...
        if (this._tooltipInstance) {
            ...
            rxjs.first.call(this._ngZone.onMicrotaskEmpty.asObservable()).subscribe(function () {
                if (_this._tooltipInstance) {
...
MdTooltip.ctorParameters = function () {
    return [
        ...
        { type: undefined, decorators: [{ type: core.Inject, args: [MD_TOOLTIP_SCROLL_STRATEGY,] },] },
        { type: bidi.Directionality, decorators: [{ type: core.Optional },] },
    ];
};
 ...
 * @nocollapse
 */
MdPaginator.ctorParameters = function () {
    return [
...
var MdRadioGroup = (function (_super) {
    ...
    function MdRadioGroup(_changeDetector) {
         ...
         */
        _this._name = "md-radio-group-" + nextUniqueId$4++;
        /**
...
var MdRadioButton = (function (_super) {
    ...
    function MdRadioButton(radioGroup, elementRef, renderer, _changeDetector, _focusMonitor, _radioDispatcher) {
        ...
        _this._uniqueId = "md-radio-" + ++nextUniqueId$4;
        /**
    ...
    MdDrawer.prototype.toggle = function (isOpen) {
        ...
        if (!this._isAnimating) {
            ...
            this._currentTogglePromise = new Promise(function (resolve) {
                rxjs.first.call(isOpen ? _this.onOpen : _this.onClose).subscribe(resolve);
            });
            if (this._focusTrap) {
                this._focusTrap.enabled = this.isFocusTrapEnabled;
            }
...
MdDrawer.decorators = [
    { type: core.Component, args: [{ selector: 'md-drawer, mat-drawer',
                template: "<ng-content></ng-content>",
                animations: [
                    animations.trigger('transform', [
 ...
 * @nocollapse
 */
MdDrawer.ctorParameters = function () {
    return [
        { type: core.ElementRef, },
        { type: a11y.FocusTrapFactory, },
        { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [platformBrowser.DOCUMENT,] },] },
...
var MdDrawerContainer = (function () {
    ...
    function MdDrawerContainer(_dir, _element, _renderer, _ngZone, _changeDetectorRef) {
         ...
         */
        this._dirChangeSubscription = Subscription.Subscription.EMPTY;
    ...
    MdDrawerContainer.prototype.ngAfterContentInit = function () {
        var _this = this;
        rxjs.startWith.call(this._drawers.changes, null).subscribe(function () {
    ...
    MdDrawerContainer.prototype._watchDrawerToggle = function (drawer) {
        var _this = this;
        rxjs.takeUntil.call(drawer._animationStarted, this._drawers.changes).subscribe(function () {
        ...
        if (drawer.mode !== 'side') {
            rxjs.takeUntil.call(merge.merge(drawer.onOpen, drawer.onClose), this._drawers.changes).subscribe(function () { return _this._setContainerClass(drawer.opened); });
        }
    };
    /**
    ...
    MdDrawerContainer.prototype._watchDrawerPosition = function (drawer) {
        ...
        rxjs.takeUntil.call(drawer.onPositionChanged, this._drawers.changes).subscribe(function () {
            rxjs.first.call(_this._ngZone.onMicrotaskEmpty.asObservable()).subscribe(function () {
                _this._validateDrawers();
            });
        });
    };
...
MdDrawerContainer.decorators = [
    { type: core.Component, args: [{ selector: 'md-drawer-container, mat-drawer-container',
 ...
 * @nocollapse
 */
MdDrawerContainer.ctorParameters = function () {
    return [
        { type: bidi.Directionality, decorators: [{ type: core.Optional },] },
        { type: core.ElementRef, },
        { type: core.Renderer2, },
...
MdDrawerContainer.propDecorators = {
    '_drawers': [{ type: core.ContentChildren, args: [MdDrawer,] },],
...
MdSidenavContainer.propDecorators = {
    '_drawers': [{ type: core.ContentChildren, args: [MdSidenav,] },],
};
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
...
var MdSlideToggle = (function (_super) {
    ...
    function MdSlideToggle(elementRef, renderer, _platform, _focusMonitor, _changeDetectorRef, tabIndex) {
        ...
        _this.onTouched = function () { };
        _this._uniqueId = "md-slide-toggle-" + ++nextUniqueId$5;
        _this._required = false;
        _this._checked = false;
        /**
         * Name value will be applied to the input element if present
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var MD_SNACK_BAR_DATA = new core.InjectionToken('MdSnackBarData');
/**
...
var MdSnackBarContainer = (function (_super) {
     ...
     * @return {?}
     */
    MdSnackBarContainer.prototype.attachComponentPortal = function (portal$$1) {
        if (this._portalHost.hasAttached()) {
...
MdSnackBarContainer.decorators = [
    { type: core.Component, args: [{ selector: 'snack-bar-container',
                ...
                animations: [
                    animations.trigger('state', [
                        // Animation from top.
                        animations.state('visible-top', animations.style({ transform: 'translateY(0%)' })),
                        animations.state('hidden-top', animations.style({ transform: 'translateY(-100%)' })),
                        animations.transition('visible-top => hidden-top', animations.animate(HIDE_ANIMATION)),
                        animations.transition('void => visible-top', animations.animate(SHOW_ANIMATION)),
                        // Animation from bottom.
                        animations.state('visible-bottom', animations.style({ transform: 'translateY(0%)' })),
                        animations.state('hidden-bottom', animations.style({ transform: 'translateY(100%)' })),
                        animations.transition('visible-bottom => hidden-bottom', animations.animate(HIDE_ANIMATION)),
                        animations.transition('void => visible-bottom', animations.animate(SHOW_ANIMATION)),
                    ])
                ],
            },] },
];
...
SimpleSnackBar.ctorParameters = function () {
    return [
        { type: MdSnackBarRef, },
        { type: undefined, decorators: [{ type: core.Inject, args: [MD_SNACK_BAR_DATA,] },] },
    ];
};
/**
...
var MdSnackBar = (function () {
    ...
    MdSnackBar.prototype._attachSnackBarContainer = function (overlayRef, config) {
        var /** @type {?} */ containerPortal = new portal.ComponentPortal(MdSnackBarContainer, config.viewContainerRef);
...
MdSort.propDecorators = {
    ...
    '_matSortActive': [{ type: core.Input, args: ['matSortActive',] },],
    '_matSortStart': [{ type: core.Input, args: ['matSortStart',] },],
    '_matSortDirection': [{ type: core.Input, args: ['matSortDirection',] },],
    '_matSortDisableClear': [{ type: core.Input, args: ['matSortDisableClear',] },],
    'sortChange': [{ type: core.Output, args: ['mdSortChange',] },],
    '_matSortChange': [{ type: core.Output, args: ['matSortChange',] },],
};
/**
...
var MdSortHeader = (function () {
    ...
    function MdSortHeader(_intl, changeDetectorRef, _sort, _cdkColumnDef) {
        ...
        this._rerenderSubscription = merge.merge(_sort.sortChange, _intl.changes).subscribe(function () {
...
MdSortHeader.decorators = [
    { type: core.Component, args: [{ selector: '[md-sort-header], [mat-sort-header]',
                ...
                changeDetection: core.ChangeDetectionStrategy.OnPush,
                animations: [
                    animations.trigger('indicator', [
                        animations.state('asc', animations.style({ transform: 'translateY(0px)' })),
                        // 10px is the height of the sort indicator, minus the width of the pointers
                        animations.state('desc', animations.style({ transform: 'translateY(10px)' })),
                        animations.transition('asc <=> desc', animations.animate(SORT_ANIMATION_TRANSITION))
                    ]),
                    animations.trigger('leftPointer', [
                        animations.state('asc', animations.style({ transform: 'rotate(-45deg)' })),
                        animations.state('desc', animations.style({ transform: 'rotate(45deg)' })),
                        animations.transition('asc <=> desc', animations.animate(SORT_ANIMATION_TRANSITION))
                    ]),
                    animations.trigger('rightPointer', [
                        animations.state('asc', animations.style({ transform: 'rotate(45deg)' })),
                        animations.state('desc', animations.style({ transform: 'rotate(-45deg)' })),
                        animations.transition('asc <=> desc', animations.animate(SORT_ANIMATION_TRANSITION))
                    ])
 ...
 */
var _MdStepLabel = stepper.CdkStepLabel;
 ...
 * @nocollapse
 */
MdStepLabel.ctorParameters = function () {
    return [
...
MdStepHeader.decorators = [
    { type: core.Component, args: [{ selector: 'md-step-header, mat-step-header',
 ...
 * Workaround for https://github.com/angular/angular/issues/17849
 */
var _MdStep = stepper.CdkStep;
var _MdStepper = stepper.CdkStepper;
...
MdStep.decorators = [
    { type: core.Component, args: [{ selector: 'md-step, mat-step',
 ...
 * @nocollapse
 */
MdStep.ctorParameters = function () {
    return [
        { type: MdStepper, decorators: [{ type: core.Inject, args: [core.forwardRef(function () { return MdStepper; }),] },] },
        { type: undefined, decorators: [{ type: core.Optional }, { type: core.SkipSelf }, { type: core.Inject, args: [MD_ERROR_GLOBAL_OPTIONS,] },] },
    ];
};
MdStep.propDecorators = {
    'stepLabel': [{ type: core.ContentChild, args: [MdStepLabel,] },],
};
...
MdStepper.propDecorators = {
    '_stepHeader': [{ type: core.ViewChildren, args: [MdStepHeader, { read: core.ElementRef },] },],
    '_steps': [{ type: core.ContentChildren, args: [MdStep,] },],
};
...
MdHorizontalStepper.decorators = [
    { type: core.Component, args: [{ selector: 'md-horizontal-stepper, mat-horizontal-stepper',
                ...
                animations: [
                    animations.trigger('stepTransition', [
                        ...
                        animations.state('current', animations.style({ transform: 'translate3d(0%, 0, 0)', visibility: 'visible' })),
...
MdVerticalStepper.decorators = [
    { type: core.Component, args: [{ selector: 'md-vertical-stepper, mat-vertical-stepper',
 ...
 * Workaround for https://github.com/angular/angular/issues/17849
 */
var _MdStepperNext = stepper.CdkStepperNext;
var _MdStepperPrevious = stepper.CdkStepperPrevious;
/**
...
MdStepperNext.decorators = [
    { type: core.Directive, args: [{
                ...
                providers: [{ provide: stepper.CdkStepper, useExisting: MdStepper }]
            },] },
];
/**
 * @nocollapse
 ...
 * Workaround for https://github.com/angular/angular/issues/17849
 */
var _MdCellDef = table.CdkCellDef;
var _MdHeaderCellDef = table.CdkHeaderCellDef;
var _MdColumnDef = table.CdkColumnDef;
var _MdHeaderCell = table.CdkHeaderCell;
var _MdCell = table.CdkCell;
/**
...
MdCellDef.decorators = [
    { type: core.Directive, args: [{
                ...
                providers: [{ provide: table.CdkCellDef, useExisting: MdCellDef }]
            },] },
];
/**
 * @nocollapse
...
MdHeaderCellDef.decorators = [
    { type: core.Directive, args: [{
                ...
                providers: [{ provide: table.CdkHeaderCellDef, useExisting: MdHeaderCellDef }]
            },] },
];
/**
 * @nocollapse
...
MdColumnDef.decorators = [
    { type: core.Directive, args: [{
                ...
                providers: [{ provide: table.CdkColumnDef, useExisting: MdColumnDef }],
            },] },
];
/**
 * @nocollapse
...
MdColumnDef.propDecorators = {
    'name': [{ type: core.Input, args: ['mdColumnDef',] },],
    '_matColumnDefName': [{ type: core.Input, args: ['matColumnDef',] },],
};
/**
 ...
 * Workaround for https://github.com/angular/angular/issues/17849
 */
var _MdHeaderRowDef = table.CdkHeaderRowDef;
var _MdCdkRowDef = table.CdkRowDef;
var _MdHeaderRow = table.CdkHeaderRow;
var _MdRow = table.CdkRow;
/**
...
MdHeaderRowDef.decorators = [
    { type: core.Directive, args: [{
                ...
                providers: [{ provide: table.CdkHeaderRowDef, useExisting: MdHeaderRowDef }],
...
MdRowDef.decorators = [
    { type: core.Directive, args: [{
                selector: '[mdRowDef]',
                providers: [{ provide: table.CdkRowDef, useExisting: MdRowDef }],
...
MdHeaderRow.decorators = [
    { type: core.Component, args: [{ selector: 'md-header-row, mat-header-row',
...
MdRow.decorators = [
    { type: core.Component, args: [{ selector: 'md-row, mat-row',
                template: table.CDK_ROW_TEMPLATE,
                host: {
                    'class': 'mat-row',
                    'role': 'row',
 ...
 * Workaround for https://github.com/angular/angular/issues/17849
 */
var _MdTabLabelBaseClass = portal.TemplatePortalDirective;
/**
...
var MdTabGroup = (function (_super) {
    ...
    function MdTabGroup(_renderer, elementRef, _changeDetectorRef) {
         ...
         */
        _this.selectChange = new core.EventEmitter(true);
...
var MdTabHeader = (function (_super) {
    ...
    MdTabHeader.prototype.ngAfterContentInit = function () {
        ...
        var /** @type {?} */ resize = typeof window !== 'undefined' ?
            rxjs.auditTime.call(fromEvent.fromEvent(window, 'resize'), 150) :
            of.of(null);
        this._realignInkBar = rxjs.startWith.call(merge.merge(dirChange, resize), null).subscribe(function () {
...
var MdTabNav = (function (_super) {
    ...
    MdTabNav.prototype.ngAfterContentInit = function () {
        ...
        this._ngZone.runOutsideAngular(function () {
            ...
            var /** @type {?} */ resize = typeof window !== 'undefined' ?
                rxjs.auditTime.call(fromEvent.fromEvent(window, 'resize'), 10) :
                of.of(null);
            return rxjs.takeUntil.call(merge.merge(dirChange, resize), _this._onDestroy).subscribe(function () {
                _this._alignInkBar();
            });
        });
        this._setLinkDisableRipple();
...
MdTabNav.propDecorators = {
    '_inkBar': [{ type: core.ViewChild, args: [MdInkBar,] },],
    '_tabLinks': [{ type: core.ContentChildren, args: [core.forwardRef(function () { return MdTabLink; }), { descendants: true },] },],
    'backgroundColor': [{ type: core.Input },],
};
...
var MdTabLink = (function (_super) {
     ...
     * @param {?} globalOptions
     */
    function MdTabLink(_mdTabNavBar, _elementRef, ngZone, ruler, platform$$1, globalOptions) {
        var _this = _super.call(this) || this;
        ...
        _this._tabLinkRipple = new MdRipple(_elementRef, ngZone, ruler, platform$$1, globalOptions);
        return _this;
    }
...
var NgxImageEditorComponent = /** @class */ (function () {
     ...
     * @param {?} _sanitizer
     */
    function NgxImageEditorComponent(dialogRef, data, _sanitizer) {
    ...
    NgxImageEditorComponent.prototype.addRatios = function (ratios) {
        ...
        ratios.forEach(function (ratioType) {
            var /** @type {?} */ addedRation = NGX_DEFAULT_RATIOS.find(function (ratio) {
    ...
    NgxImageEditorComponent.prototype.centerCanvas = function () {
        var /** @type {?} */ cropBoxLeft = (this.cropper.getContainerData().width - this.cropper.getCropBoxData().width) / 2;
        var /** @type {?} */ cropBoxTop = (this.cropper.getContainerData().height - this.cropper.getCropBoxData().height) / 2;
        var /** @type {?} */ canvasLeft = (this.cropper.getContainerData().width - this.cropper.getCanvasData().width) / 2;
        var /** @type {?} */ canvasTop = (this.cropper.getContainerData().height - this.cropper.getCanvasData().height) / 2;
        this.cropper.setCropBoxData({
            left: cropBoxLeft,
            top: cropBoxTop,
            width: this.cropper.getCropBoxData().width,
...
NgxImageEditorComponent.ctorParameters = function () { return [
    { type: MdDialogRef, },
    { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [MD_DIALOG_DATA,] },] },
    { type: platformBrowser.DomSanitizer, },
]; };
 ...
 * @nocollapse
 */
NgxImageEditorModule.ctorParameters = function () { return []; };
