(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/cdk/a11y'), require('@angular/cdk/bidi'), require('@angular/cdk/observers'), require('@angular/cdk/overlay'), require('@angular/cdk/portal'), require('@angular/platform-browser'), require('@angular/common'), require('@angular/cdk/scrolling'), require('@angular/cdk/platform'), require('@angular/cdk/keycodes'), require('@angular/cdk/coercion'), require('@angular/cdk/collections'), require('rxjs/Subject'), require('rxjs/observable/of'), require('@angular/forms'), require('@angular/cdk/rxjs'), require('rxjs/observable/merge'), require('@angular/animations'), require('@angular/http'), require('rxjs/Observable'), require('rxjs/observable/throw'), require('rxjs/observable/forkJoin'), require('rxjs/observable/fromEvent'), require('rxjs/observable/defer'), require('@angular/cdk/table'), require('@angular/flex-layout'), require('@angular/platform-browser/animations')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/cdk/a11y', '@angular/cdk/bidi', '@angular/cdk/observers', '@angular/cdk/overlay', '@angular/cdk/portal', '@angular/platform-browser', '@angular/common', '@angular/cdk/scrolling', '@angular/cdk/platform', '@angular/cdk/keycodes', '@angular/cdk/coercion', '@angular/cdk/collections', 'rxjs/Subject', 'rxjs/observable/of', '@angular/forms', '@angular/cdk/rxjs', 'rxjs/observable/merge', '@angular/animations', '@angular/http', 'rxjs/Observable', 'rxjs/observable/throw', 'rxjs/observable/forkJoin', 'rxjs/observable/fromEvent', 'rxjs/observable/defer', '@angular/cdk/table', '@angular/flex-layout', '@angular/platform-browser/animations'], factory) :
	(factory((global['ngx-image-editor'] = {}),global.ng.core,global.ng.cdk.a11y,global.ng.cdk.bidi,global.ng.cdk.observers,global.ng.cdk.overlay,global.ng.cdk.portal,global.ng.platformBrowser,global.ng.common,global.ng.cdk.scrolling,global.ng.cdk.platform,global.ng.cdk.keycodes,global.ng.cdk.coercion,global.ng.cdk.collections,global.Rx,global.Rx.Observable,global.ng.forms,global.ng.cdk.rxjs,global.Rx.Observable,global.ng.animations,global.ng.http,global.Rx,global.Rx.Observable,global.Rx.Observable,global.Rx.Observable,global.Rx.Observable,global.ng.cdk.table,global.ng['flex-layout'],global.ng.platformBrowser.animations));
}(this, (function (exports,core,a11y,bidi,observers,overlay,portal,platformBrowser,common,scrolling,platform,keycodes,coercion,collections,Subject,of,forms,rxjs,merge,animations,http,Observable,_throw,forkJoin,fromEvent,defer,table,flexLayout,animations$1) { 'use strict';
 ...
 */
var VERSION = new core.Version('2.0.0-beta.10');
...
MdRippleModule.decorators = [
    { type: core.NgModule, args: [{
                imports: [MdCommonModule, platform.PlatformModule, scrolling.ScrollDispatchModule],
...
MdOptionModule.decorators = [
    { type: core.NgModule, args: [{
                imports: [MdRippleModule, common.CommonModule, MdPseudoCheckboxModule],
 ...
 * @return {?}
 */
function FOCUS_ORIGIN_MONITOR_PROVIDER_FACTORY(parentDispatcher, ngZone, platform$$1) {
    return parentDispatcher || new FocusOriginMonitor(ngZone, platform$$1);
}
/**
 * \@docs-private
 */
var FOCUS_ORIGIN_MONITOR_PROVIDER = {
    ...
    deps: [[new core.Optional(), new core.SkipSelf(), FocusOriginMonitor], core.NgZone, platform.Platform],
...
var MdAnchor = (function (_super) {
     ...
     * @param {?} renderer
     */
    function MdAnchor(platform$$1, focusOriginMonitor, elementRef, renderer) {
        return _super.call(this, renderer, elementRef, platform$$1, focusOriginMonitor) || this;
    }
    /**
     * @param {?} event
     * @return {?}
...
var SlideToggleRenderer = (function () {
     ...
     * @param {?} platform
     */
    function SlideToggleRenderer(_elementRef, platform$$1) {
        this._elementRef = _elementRef;
        /**
...
MdSliderModule.decorators = [
    { type: core.NgModule, args: [{
                imports: [common.CommonModule, MdCommonModule, StyleModule, bidi.BidiModule],
...
var MdDrawerContainer = (function () {
    ...
    MdDrawerContainer.prototype._watchDrawerPosition = function (drawer) {
        ...
        rxjs.takeUntil.call(drawer.onPositionChanged, this._drawers.changes).subscribe(function () { return rxjs.first.call(_this._ngZone.onMicrotaskEmpty).subscribe(function () { return _this._validateDrawers(); }); });
    };
    /**
...
var MdListOption = (function () {
    ...
    Object.defineProperty(MdListOption.prototype, "value", {
         ...
         * @return {?}
         */
        set: function (val) { this._value = coercion.coerceBooleanProperty(val); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(MdListOption.prototype, "selected", {
         ...
         * @return {?}
         */
        set: function (val) { this._selected = coercion.coerceBooleanProperty(val); },
        enumerable: true,
        configurable: true
    });
    /**
...
MdChip.propDecorators = {
    '_chipRemove': [{ type: core.ContentChild, args: [core.forwardRef(function () { return MdChipRemove; }),] },],
    'selected': [{ type: core.Input },],
 ...
 * @nocollapse
 */
MdChipRemove.ctorParameters = function () {
    return [
        { type: MdChip, },
    ];
};
...
var MdSnackBarContainer = (function (_super) {
    ...
    MdSnackBarContainer.prototype._completeExit = function () {
        ...
        rxjs.first.call(this._ngZone.onMicrotaskEmpty).subscribe(function () {
            onExit.next();
            onExit.complete();
        });
    };
    ...
    { type: core.Component, args: [{ selector: 'snack-bar-container',
                ...
                animations: [
                    animations.trigger('state', [
                        animations.state('void', animations.style({ transform: 'translateY(100%)' })),
...
var MdSnackBar = (function () {
    ...
    MdSnackBar.prototype._createOverlay = function (config) {
        var /** @type {?} */ state$$1 = new overlay.OverlayState();
...
var MdTabGroup = (function (_super) {
    ...
    Object.defineProperty(MdTabGroup.prototype, "selectedIndexChange", {
         ...
         */
        get: function () {
            return rxjs.map.call(this.selectChange, function (event) { return event.index; });
        },
        enumerable: true,
        configurable: true
    });
    ...
    MdTabGroup.prototype._subscribeToTabLabels = function () {
        ...
        this._tabLabelSubscription = merge.merge.apply(void 0, this._tabs.map(function (tab) { return tab._labelChange; })).subscribe(function () {
            _this._changeDetectorRef.markForCheck();
        });
    };
    /**
    ...
    MdTabNav.prototype.ngAfterContentInit = function () {
        ...
        this._resizeSubscription = this._ngZone.runOutsideAngular(function () {
            ...
            var /** @type {?} */ resize = typeof window !== 'undefined' ?
                ...
                of.of(null);
            return rxjs.takeUntil.call(merge.merge(dirChange, resize), _this._onDestroy)
 ...
 * @return {?}
 */
function MD_TOOLTIP_SCROLL_STRATEGY_PROVIDER_FACTORY(overlay$$1) {
...
var MdTooltip = (function () {
    ...
    MdTooltip.prototype._createOverlay = function () {
        ...
        var /** @type {?} */ config = new overlay.OverlayState();
...
var MdMenu = (function () {
    ...
    MdMenu.prototype.hover = function () {
        return merge.merge.apply(void 0, this.items.map(function (item) { return item.hover; }));
    };
    /**
 ...
 * @return {?}
 */
function MD_MENU_SCROLL_STRATEGY_PROVIDER_FACTORY(overlay$$1) {
...
var MdMenuTrigger = (function () {
    ...
    MdMenuTrigger.prototype._getOverlayConfig = function () {
        var /** @type {?} */ overlayState = new overlay.OverlayState();
 ...
 * @return {?}
 */
function MD_DIALOG_SCROLL_STRATEGY_PROVIDER_FACTORY(overlay$$1) {
 ...
 * @nocollapse
 */
MdDialogClose.ctorParameters = function () {
    return [
        { type: MdDialogRef, },
    ];
};
MdDialogClose.propDecorators = {
    ...
    '_mdDialogClose': [{ type: core.Input, args: ['mdDialogClose',] },],
    '_matDialogCloseResult': [{ type: core.Input, args: ['mat-dialog-close',] },],
};
/**
 ...
 * @return {?}
 */
function MD_AUTOCOMPLETE_SCROLL_STRATEGY_PROVIDER_FACTORY(overlay$$1) {
    return function () { return overlay$$1.scrollStrategies.reposition(); };
}
/**
 * \@docs-private
...
var MdAutocompleteTrigger = (function () {
    ...
    MdAutocompleteTrigger.prototype._subscribeToClosingActions = function () {
        var _this = this;
        var /** @type {?} */ firstStable = rxjs.first.call(this._zone.onStable);
...
MdAutocompleteModule.decorators = [
    { type: core.NgModule, args: [{
                imports: [MdOptionModule, overlay.OverlayModule, MdCommonModule, common.CommonModule],
...
var MdCalendar = (function () {
    ...
    MdCalendar.prototype._focusActiveCell = function () {
        var _this = this;
        this._ngZone.runOutsideAngular(function () {
            return rxjs.first.call(_this._ngZone.onStable).subscribe(function () {
...
var MdDatepicker = (function () {
    ...
    MdDatepicker.prototype._openAsPopup = function () {
        ...
        if (!this._popupRef.hasAttached()) {
            ...
            rxjs.first.call(this._ngZone.onStable).subscribe(function () { return _this._popupRef.updatePosition(); });
        }
    ...
    { type: core.Component, args: [{ selector: 'md-expansion-panel-header, mat-expansion-panel-header',
                ...
                animations: [
                    ...
                    animations.trigger('expansionHeight', [
                        animations.state('collapsed', animations.style({ height: '48px' })),
                        animations.state('expanded', animations.style({ height: '64px' })),
                        animations.transition('expanded <=> collapsed', animations.animate(EXPANSION_PANEL_ANIMATION_TIMING)),
                    ]),
                ],
            },] },
...
var MdSortHeader = (function () {
    ...
    function MdSortHeader(_intl, changeDetectorRef, _sort, _cdkColumnDef) {
        ...
        this._rerenderSubscription = merge.merge(_sort.mdSortChange, _intl.changes).subscribe(function () {
